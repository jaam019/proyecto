...
/*10 consultas a la base de datos con su respectiva descripción 
...
3-suma todo lo de telefono
SELECT SUM(telefono) FROM trabajor;
4-maximo peso del ganado de chequeo 
SELECT MAX(peso) FROM chequeo;
5-consulta de la minima cantidad de suministro
SELECT MIN(cantidad) FROM suministro;

6-consulta de trascurrido entre f ¨x" a "y"
...
10 consultas empleando el uso de JOINS 
